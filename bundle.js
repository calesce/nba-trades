...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render:function(){
	      return (
	        React.createElement("div", {className: "player"}, 
	          React.createElement("img", {src: this.props.data.imageUrl, height: "37px", width: "46px"}), 
	...
	var Team =
	  React.createClass({displayName: "Team",
	    render: function() {
	      return (
	        React.createElement("div", null, 
	           this.props.data.players.map(function(player) {
	              return React.createElement(Player, {key: player.name, data: player});
	            })
	...
	var TeamSelector =
	  React.createClass({displayName: "TeamSelector",
	    ...
	    teamSelected: function(event) {
	      ...
	      React.render(React.createElement(Team, {data: teams[event.target.value]}), document.getElementById('teamArea'));
	    },
	    render: function() {
	      return (
	        React.createElement("div", {className: "input-field"}, 
	          React.createElement("select", {onChange: this.teamSelected}, 
	            React.createElement("option", {value: "hey"}, "Select team"), 
	             Object.keys(teams).map(function(team, index) {
	                return React.createElement("option", {key: team, value: team}, team)
	              })
	...
	var TradeMachine = 
	  React.createClass({displayName: "TradeMachine",
	    getInitialState: function() {
	      return {
	        teamSelectors: ['0']
	      };
	    ...
	    addTeam: function() {
	      var count = this.state.teamSelectors.length;
	      if(count === 4) {
	        count -= 1;
	      } else {
	        count += 1;
	      ...
	      this.setState({ teamSelectors: selectors });
	    },
	    render: function() {
	      return (
	        React.createElement("div", null, 
	           this.state.teamSelectors.map(function(team) {
	              return React.createElement(TeamSelector, null)
	            }), 
	          
	          React.createElement("button", {onClick: this.addTeam}, "Add Team")
	        )
	      );
	    }
	  });
	  ...
	  http.onload = function () {
	    teams = JSON.parse(http.responseText);
	    ...
	    React.render(React.createElement(TradeMachine, null), document.getElementById('tradeMachine'));
	  };
	};
